...
struct qt_meta_stringdata_CLASSHeaderENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSHeaderENDCLASS = QtMocHelpers::stringData(
    "Header"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSHeaderENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Header::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSHeaderENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSHeaderENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSHeaderENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Header::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSHeaderENDCLASS.stringdata0))
