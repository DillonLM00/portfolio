...
public:
    ...
    void retranslateUi(QWidget *AboutMe)
    {
        ...
        textGTKLabel->setText(QCoreApplication::translate("AboutMe", "<html><head/><body><p>Hello, my name is Dillon Leonardo Metzler and I am currently studying Computer Science - Game Engineering in my 8th semester at Kempten University of Applied Sciences.<br/><br/>Games are my passion!</p><p>During my studies I discovered my enthusiasm for games programming in particular. I also gained experience in the areas of modelling, animation and implementation. Through projects as part of my studies or in my free time, where I took part in game jams, I have acquired good knowledge of Godot, Unity, C# and C++. Also I learnt the importance of planning, structuring, communication, defining clear interfaces and implementing time management within a development team.</p><p>Additionally during my work as a student assistant at the Institute for Production and Computer Science in Sonthofen I have been intensively involved with Qt for software development.<br/><br/>Currently I am writing my bachelor's thesis at the IPI in Sonthofen in the area of embedded systems and furthermore I am continu"
                        "ing my work there as a student assistant in part-time parallel to my bachelor's thesis.<br/><br/>I'm open to Job opportunities where I can contribute, learn and grow. If you have a good opportunity that matches my skills and experience then don't hesitate to contact me.</p></body></html>", nullptr));
